class Museum{
  ...
  int yearOfHistory;
         ...
         public Museum(int id , String name , String location , int noOfEmployes , int yearOfHistory){
    ...
    public void getdisplay(){
		...
		System.out.println("Year Of History For That Museum:  " + this.yearOfHistory);
